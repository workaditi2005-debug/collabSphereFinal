...
Provide personalized feedback in ONLY valid JSON format with no markdown or preamble:
{
  ...
  "recommendations": "next steps or study suggestions"
      ...
      setFeedback({
        overallFeedback: `You scored ${score} out of ${currentQuiz.questions.length} questions correctly!`,
        strengths: 'Keep up the good work!',
        improvements: 'Review the questions you missed.',
        recommendations: 'Practice more to improve your skills.'
      });
    } finally {
      setIsGenerating(false);
    }
  ...
  const resetQuiz = () => {
    ...
    setTimeTaken([]);
    setQuizConfig({ topic: '', difficulty: 'medium', questionCount: 5, timeLimit: 60 });
  };
